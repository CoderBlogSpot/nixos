# ~/.config/qtile/config.py 
 ...
 keys = [ 
     # Google Chrome
     Key([mod], "c", lazy.spawn("google-chrom-stable"), desc="Launch browser"), 
     Key([mod, "shift"], "c", lazy.spawn("google-chrom-stable --incognito"), desc="Do forbidden stuff"), 
     Key([mod, "control"], "c", lazy.spawn("google-chrome-stable https://www.youtube.com/playlist?list=WL"), desc="Open YouTube Watchlist"), 
 ...
 screens = [ 
     Screen( 
         wallpaper="~/pictures/wallpapers/gruvbox-forest.jpg", 
         wallpaper_mode="fill", 
         top=bar.Bar( 
             [ 
